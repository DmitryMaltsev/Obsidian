...
![Паттерн&nbsp;Декоратор](https://refactoring.guru/images/patterns/content/decorator/decorator.png)
...
![Структура библиотеки до применения Декоратора](https://refactoring.guru/images/patterns/diagrams/decorator/problem1-ru.png)
...
![Библиотека после добавления других типов оповещений](https://refactoring.guru/images/patterns/diagrams/decorator/problem2.png)
...
![Библиотека после комбинирования оповещений](https://refactoring.guru/images/patterns/diagrams/decorator/problem3.png)
...
![Наследование против Агрегации](https://refactoring.guru/images/patterns/diagrams/decorator/solution1-ru.png)
...
![Схема решения Декоратором](https://refactoring.guru/images/patterns/diagrams/decorator/solution2.png)
...
![Программа может составлять сложные стеки декораторов](https://refactoring.guru/images/patterns/diagrams/decorator/solution3-en.png)
...
![Пример паттерна Декоратор](https://refactoring.guru/images/patterns/content/decorator/decorator-comic-1.png)
...
![Структура классов паттерна Декоратор](https://refactoring.guru/images/patterns/diagrams/decorator/structure.png)
...
![Структура классов примера паттерна Декоратор](https://refactoring.guru/images/patterns/diagrams/decorator/example.png)
