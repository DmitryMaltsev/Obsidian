...
![Паттерн&nbsp;Одиночка](https://refactoring.guru/images/patterns/content/singleton/singleton.png?id=108a0b9b5ea5c4426e0a)
...
![Глобальный доступ к одному объекту](https://refactoring.guru/images/patterns/content/singleton/singleton-comic-1-ru.png?id=c3a9bfe5411ebd5c1220)
...
![Структура классов паттерна Одиночка](https://refactoring.guru/images/patterns/diagrams/singleton/structure-ru.png?id=da49955f21ea6fcf9ae4)
